    ...
    if (message.guild) {
        ...
        if (command == "setup") {
            ...
            let embed = new discord.MessageEmbed()
                ...
                .setDescription(`♅ ANOUNIMOS ♅
 **Bot - Help Menu:**
 
- -**Prefix: b**
- -**Developer: ANOUNIMOS**
- -**Discord Server: https://discord.gg/r2uGrKH58v** 
- -**Server ID: 1191663192049455185**
- -**Commands:**
    ...
    if (message.member.hasPermission('ADMINISTRATOR')) {
      ...
      if (!message.guild.roles.cache.some(role => role.name === roleName)) {
        ...
        const createdRole = await message.guild.roles.create({
          data: {
            name: roleName,
            color: '#ff6600', // يمكنك تغيير لون الرول حسب احتياجاتك
          },
